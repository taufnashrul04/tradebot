#!/usr/bin/env python3
"""
Quick Start - Jalankan 5 cycles untuk testing limit order strategy.
"""
import asyncio
from strategy_limit_order import HighVolumeLimitStrategy


async def quick_start():
    """Jalankan 5 cycles untuk testing."""
    print("\n" + "="*70)
    print("🚀 QUICK START - 5 CYCLES TESTING (LIMIT ORDER)")
    print("="*70)
