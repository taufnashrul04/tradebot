#!/usr/bin/env python3
"""
Test Mean Reversion Bot with 30s timeframe
- TP: 0.2%
- SL: 0.15%
- Hold time: 10s
- Timeframe: 30s (capture micro-movements)
"""
...
async def test_30s_timeframe():
    """Test mean reversion bot with 30s timeframe"""
    print("🧪 Testing Mean Reversion Bot (30s Timeframe)...")
    print("=" * 60)
    print("📋 Settings:")
    ...
    print("   SL: 0.15%")
    print("   Hold Time: 10s")
    print("   Timeframe: 30s (capture micro-movements)")
    ...
    bot = MeanReversionBot(
        ...
        symbol="BTC/USDT",
        timeframe="30s",  # 30s timeframe (capture micro-movements)
        leverage=40,
        balance_usd=20.0,
...
if __name__ == "__main__":
    asyncio.run(test_30s_timeframe())
